...
<script>
    import {listSpecs, saveSpecsList} from '../../api/product'
    import {getProductList, deleteProduct} from '../../api/productTemp'
    ...
    export default {
        ...
        methods: {
            ...
            handleUpdateProduct(index, row) {
                this.$router.push({path: '/drafts/updateProduct', query: {id: row.id}});
            },
